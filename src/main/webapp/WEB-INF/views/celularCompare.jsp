			...
			<tbody>
				<tr>
					...
					<td width="16%" style="vertical-align: middle">
						<button class="btn btn-default" style="{{celularesComparacao[0].modelo == null ? 'visibility: hidden;':''}}" data-toggle="modal"
							ng-click="limpar(1)" id="limpar" type="button">Limpar</button>
					</td>
					<td width="30%" style="vertical-align: middle">{{celularesComparacao[1].modelo}}</td>
					<td width="16%" style="vertical-align: middle">
						<button class="btn btn-default" style="{{celularesComparacao[1].modelo == null ? 'visibility: hidden;':''}}" data-toggle="modal"
							ng-click="limpar(2)" id="limpar" type="button">Limpar</button>
					</td>

					<td>
						<button class="btn btn-primary" disabled="disabled"
							data-toggle="modal" ng-click="compare()" id="compare"
							type="button">Comparar</button>
				...
				<tr ng-repeat="phone in celulares">
					...
					<td>
						<form id="{{'formFavorito#'+ phone.idCelular}}"
							...
							<a href="#" ng-click="favorito(phone.idCelular)">Favorito</a>
		...
		<div id="comparativo_dialog" class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<table id="table_comparativo" class="table table-striped">
						<thead>
							<tr>
								<th>Requisito</th>
						...
						<tbody>
							...
							<tr ng-repeat="requisito in comparativo.requisitos">
								...
								<td width="30%">{{requisito.valorCelular1}}{{requisito.celular1emelhor
									? ' (Melhor)':''}}</td>
								<td width="30%">{{requisito.valorCelular2}}{{requisito.celular2emelhor
									? ' (Melhor)':''}}</td>
							</tr>
						</tbody>
					</table>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default"
						ng-click="fecharComparativo()">Fechar</button>
				</div>
