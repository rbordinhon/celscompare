...
import rbprojects.celscompare.config.CelsCompareConfig;
import rbprojects.celscompare.config.PersistenceConfigs;
...
import rbprojects.celscompare.service.CelsCompareServiceHelper;
...
public class CelularCompareServiceTeste {
	...
	public void testeAddFavorito(){
	    ...
	    int i = 0;
	    Assert.assertEquals(1,  vos[i++].rank);    
	    Assert.assertEquals(2,  vos[i++].rank); 
	    Assert.assertEquals(3,  vos[i++].rank); 
	    Assert.assertEquals(3,  vos[i++].rank); 
	    Assert.assertEquals(4,  vos[i++].rank); 
	    Assert.assertEquals(5,  vos[i++].rank); 
	    Assert.assertEquals(6,  vos[i++].rank); 
	    Assert.assertEquals(7,  vos[i++].rank); 
	    Assert.assertEquals(8,  vos[i++].rank); 
	    Assert.assertEquals(9,  vos[i++].rank); 
	    i = 0;    
